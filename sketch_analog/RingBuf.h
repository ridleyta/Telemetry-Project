...
#ifndef __RINGBUF_H
	#define __RINGBUF_H
	#define RBUF_SIZE		0x0200	/* 512 - Do NOT change */
	#define TWO_BUF_SIZE	0x0400	/* 1024- Use two 	   */
	#define FULL_MASK		0x01FF	/* 9 bits (512 - 1)    */
	#define COUNT_MASK		0x03FF	/* 10 bits (1024 - 1)  */
